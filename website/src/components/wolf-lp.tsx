  ...
  return (
    <group {...props} dispose={null}>
      <group name="Sketchfab_Scene">
        <group name="Sketchfab_model" rotation={[0, Math.PI/2, 0]}>
          <group name="f1ec99d20c984c7bb13d3a90ebea3858fbx" rotation={[0, Math.PI/2, 0]}>
            <group name="Object_2">
              <group name="RootNode">
                <group name="Object_4">
                  <primitive object={nodes._rootJoint} />
                  <group name="Object_6" rotation={[-Math.PI / 2, 0, 0]} scale={0.001} />
                  <group name="wolf_base_mesh" rotation={[-Math.PI / 2, 0, 0.087]} scale={0.001} />
                  <group name="��������001" rotation={[-Math.PI / 2, 0, 0]} scale={0.001} />
                  <group name="������������001" rotation={[-Math.PI / 2, 0, 0]} scale={0.001} />
